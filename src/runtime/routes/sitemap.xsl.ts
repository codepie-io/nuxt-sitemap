...
export default defineEventHandler(async (e) => {
  ...
  const { version, moduleConfig } = useRuntimeConfig()['nuxt-sitemap'] as any as ModuleRuntimeConfig

  const creditName = `<a href="https://github.com/harlan-zw/nuxt-sitemap" style="color: black; font-weight: 500;" target="_blank" rel="noopener">Nuxt
